            ...
            if (type == POINT_MOTION_TYPE)
            {
                switch (id)
                {
                    ...
                    case 9:
                        ...
                        me->RemoveByteFlag(UNIT_FIELD_BYTES_1, UNIT_BYTES_1_OFFSET_ANIM_TIER, Ground | Hover);
                    ...
                    case 10:
                        ...
                        me->SetByteFlag(UNIT_FIELD_BYTES_1, UNIT_BYTES_1_OFFSET_ANIM_TIER, Ground | Hover);
