        ...
        struct boss_leotheras_the_blindAI : public BossAI
        {
            ...
            void SummonedCreatureDies(Creature* summon, Unit*)
            {
                ...
                if (summon->GetEntry() == NPC_GREYHEART_SPELLBINDER)
                    if (!summons.GetCreatureWithEntry(NPC_GREYHEART_SPELLBINDER))
                    {
                        me->RemoveAllAuras();
                        me->LoadEquipment();
    ...
    public:
        ...
        struct npc_inner_demonAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* summoner)
            {
                ...
                ownerGUID.Set(summoner->GetGUID());
                events.Reset();
...
class spell_leotheras_whirlwind : public SpellScriptLoader
{
    public:
        ...
        class spell_leotheras_whirlwind_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_leotheras_whirlwind_SpellScript::HandleDummy, EFFECT_2, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
            ...
            void HandleEffectRemove(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
            {
                if (GetTargetApplication()->GetRemoveMode() != AURA_REMOVE_BY_DEFAULT)
                    if (InstanceScript* instance = GetUnitOwner()->GetInstanceScript())
                        if (Creature* leotheras = ObjectAccessor::GetCreature(*GetUnitOwner(), instance->GetObjectGuid(NPC_LEOTHERAS_THE_BLIND)))
...
class spell_leotheras_clear_consuming_madness : public SpellScriptLoader
{
    public:
        ...
        class spell_leotheras_clear_consuming_madness_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_leotheras_clear_consuming_madness_SpellScript::HandleDummy, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
