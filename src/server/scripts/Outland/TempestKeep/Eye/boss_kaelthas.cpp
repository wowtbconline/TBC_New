    ...
    public:
        ...
        struct boss_kaelthasAI : public BossAI
        {
            ...
            void SummonedCreatureDies(Creature* summon, Unit*)
            {
                ...
                if (summon->GetGUID() && phase == PHASE_ALL_ADVISORS)
                {
                    for (SummonList::const_iterator i = summons.begin(); i != summons.end(); ++i)
                        if (Creature* summon = ObjectAccessor::GetCreature(*me, *i))
                            if (summon->GetGUID() && summon->IsAlive())
                                return;
            ...
            void MovementInform(uint32 type, uint32 point)
            {
                ...
                else if (point == POINT_START_LAST_PHASE)
                {
                    ...
                    events.DelayEvents(60000); // @todo, is it DelayEvents?  -- SetTimer
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                switch (events2.ExecuteEvent())
                {
                    ...
                    case EVENT_PREFIGHT_PHASE71:
                        ...
                        me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE|UNIT_FLAG_IMMUNE_TO_PC /*UNIT_FLAG_DISABLE_MOVE*/);
                        if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0))
                            AttackStart(target);
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_SPELL_MIND_CONTROL:
                        ...
                        me->CastSpell(me, SPELL_MIND_CONTROL, SPELLVALUE_MAX_TARGETS);
                        break;
...
class spell_kaelthas_summon_weapons : public SpellScriptLoader
{
    public:
        ...
        class spell_kaelthas_summon_weapons_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_kaelthas_summon_weapons_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_kaelthas_mind_control : public SpellScriptLoader
{
    public:
        ...
        class spell_kaelthas_mind_control_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_kaelthas_mind_control_SpellScript::SelectTarget, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
...
class spell_kaelthas_gravity_lapse : public SpellScriptLoader
{
    public:
        ...
        class spell_kaelthas_gravity_lapse_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_kaelthas_gravity_lapse_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
...
class spell_kaelthas_nether_beam : public SpellScriptLoader
{
    public:
        ...
        class spell_kaelthas_nether_beam_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_kaelthas_nether_beam_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_kaelthas_summon_nether_vapor : public SpellScriptLoader
{
    public:
        ...
        class spell_kaelthas_summon_nether_vapor_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_kaelthas_summon_nether_vapor_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
