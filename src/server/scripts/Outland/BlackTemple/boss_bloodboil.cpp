...
class spell_gurtogg_bloodboil : public SpellScriptLoader
{
    public:
        ...
        class spell_gurtogg_bloodboil_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_gurtogg_bloodboil_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
...
class spell_gurtogg_eject : public SpellScriptLoader
{
    public:
        ...
        class spell_gurtogg_eject_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gurtogg_eject_SpellScript::HandleDummy, EFFECT_2, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
